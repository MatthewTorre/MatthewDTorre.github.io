...
export const certifications: Certification[] = [
  ...
  {
    id: "citi-group7-biomed-gcp",
    title: "Group 7: IRB BioMed/GCP Research",
    issuer: "CITI Program",
    issued: "2024-08",
    expires: "2027-08",
    credentialUrl: "",
    credentialId: "64628966",
    context: "IRB/GCP certification for biomedical research—ethics, consent, and compliant clinical data handling.",
    long: "Training in human‑subjects ethics and Good Clinical Practice for biomedical research; confident handling of compliant data, consent, and protocols.",
    logoKey: "citi-program",
    tags: ["Compliance"],
    source: "Certification",
  },
  {
    id: "citi-group2-nonmedical",
    title: "Group 2: IRB Nonmedical Research",
    issuer: "CITI Program",
    issued: "2024-01",
    expires: "2027-01",
    credentialUrl: "",
    credentialId: "60648074",
    context: "IRB certification for social/behavioral research—protocols, privacy, and human-subjects protections.",
    long: "Social/behavioral research compliance—privacy, risk mitigation, and protocol design for nonmedical studies.",
    logoKey: "citi-program",
    tags: ["Compliance"],
    source: "Certification",
  },
