...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    location: 'Stanford, CA',
    mode: 'Part-time',
    summary: 'Ran demos, workshops, and student onboarding for Perplexity; gathered product feedback from campus users.',
    skills: ['Community Building', 'Product Evangelism'],
    logoKey: 'perplexity_ai_logo',
    cats: ['Leadership', 'AI/ML', 'Product'],
  },
  {
    id: 'pincs-research-assistant',
    title: 'Research Assistant',
    org: 'Stanford Computer Science — PinCS Lab (Chris Gregg)',
    start: '2025-01',
    end: 'Present',
    location: 'Stanford, CA',
    mode: 'Hybrid',
    summary: 'Applied systems + AI methods in the PinCS Lab under Prof. Chris Gregg; building tooling for program analysis and compiler research.',
    skills: ['Systems', 'Program Analysis', 'AI/ML'],
    logoKey: 'stanford_university_department_of_computer_science_logo',
    cats: ['Research', 'Systems', 'AI/ML'],
  },
  {
